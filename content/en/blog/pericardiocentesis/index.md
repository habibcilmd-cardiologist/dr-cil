...
- question: Is pericardiocentesis painful?
  answer: It is performed under local anesthesia and usually no pain is felt. A pressure sensation may occur during the procedure, but pain is minimal.
- question: Does fluid accumulate again after pericardiocentesis?
  answer: It depends on the underlying cause. It may recur in cancer or some chronic diseases. In such cases, permanent drain or pericardial window may be required.
- question: How long does pericardiocentesis take?
  answer: The procedure usually takes 30-60 minutes. It may vary depending on the amount of fluid and patient's condition.
- question: When will I be discharged after pericardiocentesis?
  answer: Usually discharge is possible after 1-2 days of observation. Earlier discharge is possible in patients with uncomplicated course.
- question: What are the risks of pericardiocentesis?
  answer: Serious complications are rare (less than 5%). Heart perforation, arrhythmia, pneumothorax, and infection are potential risks.
- question: Why does fluid accumulate in the pericardium?
  answer: Infections (viral, bacterial, tuberculosis), cancer, kidney failure, autoimmune diseases, post-cardiac surgery, or trauma can cause fluid accumulation.
- question: What is cardiac tamponade?
  answer: It is when fluid accumulated in the pericardial space compresses the heart and impairs its pumping function. It requires emergency intervention and is life-threatening.
- question: What should I do after pericardiocentesis?
  answer: Attend regular check-ups, continue treatment of the underlying cause, and seek immediate medical attention if sudden chest pain or shortness of breath occurs.
---
...
Pericardiocentesis is draining fluid accumulated in the pericardial space (the area between the membrane surrounding the heart and the heart itself) using a needle and catheter. Normally, this space contains only 15-50 ml of fluid that allows the heart to move freely.
...
There are many causes of fluid accumulation in the pericardium:

### Infectious Causes

-   **Viral pericarditis:** Most common cause (Coxsackie, Echovirus, Adenovirus)
...
Cardiac tamponade is when pericardial fluid compresses the heart and prevents it from filling during diastole (relaxation phase). It is life-threatening.
...
-   **Echocardiography:** Determining the amount and location of fluid
...
1. **Sterile preparation:** Sterilization of the chest area
...
The obtained fluid is sent for the following tests:
...
Pericardiocentesis is a safe procedure in experienced hands, but some risks exist:
...
-   **Echocardiography check:** Checking for fluid recurrence (after 24-48 hours)
-   **Clinical monitoring:** Following symptoms
-   **Treatment of underlying cause:** Infection, cancer, etc.

### In Case of Recurrent Effusion

In some patients, fluid may reaccumulate. In such cases:
