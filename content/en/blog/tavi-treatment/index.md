...
1.  **Anesthesia:** The procedure is usually performed under sedation (a state of deep sleep) and local anesthesia, rather than general anesthesia. This allows the patient to have a more comfortable experience and wake up faster.
2.  **Access Route:** The most common and least invasive method is the **transfemoral** approach. The surgeon makes a small incision in the artery in the groin. If this artery is not suitable, alternative routes such as **transapical** (through a small incision in the chest wall at the heart's apex), **transaortic** (through the front of the chest), or subclavian (under the collarbone) may be used.
3.  **Catheter Advancement:** A thin tube (catheter) is inserted through the access point and advanced through the blood vessels to the heart's aortic valve. This entire process is visualized in real-time using fluoroscopy (a type of X-ray) and echocardiography.
4.  **Valve Placement:** The compressed new biological valve, located inside the catheter, is precisely positioned within the diseased valve. The valve is then deployed either by inflating a balloon (for balloon-expandable valves) or by self-expansion (for self-expanding valves).
5.  **Final Checks:** Once the new valve is in place, its function is checked with echocardiography and angiography. The team checks for any leaks, and then the catheters are withdrawn and the access site is closed.
...
**Info:** The heart is not stopped during the TAVI procedure, and a heart-lung machine is generally not needed. This significantly reduces the physical stress of the procedure on the body.
{{< /alert >}}
...
**Warning:** If you experience dizziness, a sudden increase in shortness of breath, fever, or bleeding/swelling at the access site within the first few days after TAVI, you should contact your doctor immediately.
{{< /alert >}}
...
{{< alert icon="circle-info" cardColor="#1e3a5f" iconColor="#60a5fa" textColor="#f8fafc" >}}
**Important:** Aortic stenosis usually progresses slowly and may not cause symptoms for a long time. Regular cardiology check-ups ensure early detection and timely treatment of the disease.
{{< /alert >}}
...
{{< button href="/en/contact/" target="_self" >}}
Make an Appointment
{{< /button >}}
...
<script type="application/ld+json">
{
  ...
  "@graph": [
    {
      "@type": "Article",
      "headline": "TAVI Treatment: Minimally Invasive Aortic Valve Replacement",
      ...
      "author": {
        "@type": "Person",
        "name": "Assoc. Prof. Habib ÇİL",
        "jobTitle": "Cardiology Specialist",
        "url": "https://drcil.com/en/about/"
      },
      "publisher": {
        "@type": "Organization",
        "name": "Assoc. Prof. Habib Çil | Cardiology Specialist",
        "logo": {
          "@type": "ImageObject",
          "url": "https://drcil.com/img/logo.svg"
        }
      },
      ...
      "mainEntityOfPage": {
        "@type": "WebPage",
        "@id": "https://drcil.com/en/blog/tavi-treatment/"
      }
    },
    {
      "@type": "FAQPage",
      "mainEntity": [
        {
          "@type": "Question",
          "name": "Is the TAVI procedure painful?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "No, the patient does not feel pain during the TAVI procedure as they are under sedation. There may be mild discomfort or bruising at the access site afterward, but this is easily managed with pain relievers. There is no major incision pain like in open-heart surgery."
          }
        },
        {
          "@type": "Question",
          "name": "How long will I stay in the hospital after TAVI?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Patients are typically ready for discharge within 1 to 3 days after the TAVI procedure. This period may vary depending on the patient's overall condition and post-procedure progress."
          }
        },
        {
          "@type": "Question",
          "name": "How long does a TAVI valve last?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Current clinical data show that TAVI valves function well for at least 10-15 years. As technology advances and newer generation valves are used, this duration is expected to be even longer. Valve function is monitored with annual echocardiograms."
          }
        },
        {
          "@type": "Question",
          "name": "Can TAVI be performed at any age?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "There is no strict age limit for TAVI. The decision is based on the patient's biological age, overall health, and surgical risk. While it is often preferred for older patients, it can also be a suitable option for younger patients who are at intermediate or even low risk."
          }
        },
        {
          "@type": "Question",
          "name": "Why is a pacemaker needed after TAVI?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "The new valve is placed close to the heart's own electrical conduction system. Sometimes, this placement can put pressure on the conduction system, causing a slowdown in heart rate (conduction block). If this becomes permanent, a pacemaker is needed to regulate the heart rate. This risk is about 5-15%."
          }
        },
        {
          "@type": "Question",
          "name": "When can I return to my normal life after TAVI?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Most patients can return to normal daily activities like driving and shopping within 1-2 weeks. It is recommended to wait for your doctor's approval before engaging in more strenuous activities and sports. The recovery is much faster compared to open-heart surgery."
          }
        },
        {
          "@type": "Question",
          "name": "Are the valves used for TAVI metallic?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "No, TAVI valves are biological. They consist of leaflets made from bovine or porcine pericardium (heart sac tissue) mounted on a stent (a metal mesh frame) made of nickel-titanium (nitinol) or cobalt-chromium alloy. These valves do not make a clicking sound like metallic valves and usually do not require lifelong use of strong blood thinners like Coumadin."
          }
        },
        {
          "@type": "Question",
          "name": "Can't aortic stenosis be treated with medication?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "No. Aortic stenosis is a mechanical problem—a physical narrowing of the valve. Medications can help alleviate symptoms of heart failure or control blood pressure, but they cannot open a narrowed valve. The only effective treatment for severe aortic stenosis is to replace the valve (either surgically or with TAVI)."
          }
        }
      ]
    }
