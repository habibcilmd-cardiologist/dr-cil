...
- question: "Why does leg pain occur while walking?"
  answer: "Due to narrowing of leg arteries, muscles cannot receive adequate oxygenated blood during exercise, causing cramp-like pain (claudication)."
- question: "Can peripheral artery disease be treated?"
  answer: "Yes, it can be successfully treated with lifestyle changes (quitting smoking, walking), medication, and angiographic procedures (balloon/stent) to open the vessels."
- question: "Does walking distance increase after stenting?"
  answer: "Yes, after vessel patency is restored, blood flow improves and patients' walking distance significantly increases; they can walk without pain."
- question: "What is critical limb ischemia?"
  answer: "It is the advanced stage of the disease. It is characterized by pain even at rest, non-healing foot wounds, or discoloration/gangrene in toes. It requires urgent intervention."
- question: "Should smoking be stopped?"
  answer: "Absolutely. Smoking is the most important cause of vascular blockage. Continuing to smoke after treatment significantly increases the risk of re-occlusion."
---
...
{{< lead >}}
Lower Extremity Arterial Disease (LEAD) is commonly known as "leg artery blockage." This condition, which manifests especially with leg pain that comes on with walking (window shopper's disease), can lead to serious consequences up to limb loss if left untreated. Interventional Cardiologist Assoc. Prof. Dr. Habib Çil provides detailed information about non-surgical treatment (balloon and stent) of leg vessel blockages.
{{< /lead >}}
...
{{< alert "danger" >}}
If there is a non-healing wound, rest pain, or discoloration in toes, there is a **risk of limb loss**. A vascular specialist should be consulted immediately.
{{< /alert >}}
