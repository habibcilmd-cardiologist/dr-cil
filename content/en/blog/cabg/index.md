...
- question: Is bypass surgery risky?
  answer: With modern techniques, surgical success is over 95%. Risk varies by patient; age, comorbidities, and heart condition are the main factors.
- question: How long will I live after bypass?
  answer: 10-year survival is 80-90%. Lifestyle changes, regular medication use, and follow-up are important.
- question: Can I exercise after bypass?
  answer: Yes, regular exercise is recommended after recovery (usually 3 months). Walking, cycling, and swimming are safe activities.
- question: How long do bypass grafts last?
  answer: LIMA (left internal mammary artery) graft can last 20+ years, saphenous vein graft 10-15 years. Arterial grafts last longer.
- question: Can I have stent instead of bypass?
  answer: In some patients, yes. The decision is made by the heart team based on the number of vessels, location of blockage, and patient's overall condition.
- question: How long does bypass surgery take?
  answer: Surgery usually takes 3-6 hours. It may vary depending on the number of bypasses and technique used.
- question: How many days in hospital after bypass?
  answer: Generally 1-2 days in ICU, 5-7 days in ward, totaling 7-10 days in hospital.
- question: What is off-pump bypass?
  answer: It is bypass surgery performed while the heart is beating, without cardiopulmonary bypass machine. Applied in selected patients with certain advantages.
---
