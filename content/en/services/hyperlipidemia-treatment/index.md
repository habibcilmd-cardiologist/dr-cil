...
faq:
    - question: "What is Hyperlipidemia (High Cholesterol)?"
      answer: "Hyperlipidemia is a condition where fat (lipid) levels in the blood, specifically cholesterol and triglycerides, are higher than normal. This can lead to atherosclerosis and heart diseases."
    - question: "What are the symptoms of hyperlipidemia?"
      answer: "High cholesterol usually progresses silently without obvious symptoms. In advanced stages, fat deposits around the eyes (xanthelasma) or thickening tendons may be seen. However, a definitive diagnosis is made via blood test."
    - question: "Why does cholesterol increase?"
      answer: "Unhealthy diet (rich in saturated fats), physical inactivity, obesity, smoking, genetic factors, and certain diseases (diabetes, hypothyroidism) can cause high cholesterol."
    - question: "How long does hyperlipidemia treatment last?"
      answer: "Hyperlipidemia treatment is generally a lifelong process. Lipid levels are kept under control through lifestyle changes and medication if necessary."
    - question: "Can cholesterol be lowered without medication?"
      answer: "For mild elevations, cholesterol levels can be reduced with diet, exercise, and weight control. However, medication is essential for high-risk patients or genetic hyperlipidemias."
    - question: "Are cholesterol medications (statins) harmful?"
      answer: "Statins are safe medications proven to reduce the risk of heart attack and stroke. Like any drug, they may have side effects, but the benefit-risk ratio favors heart health. They should be used under doctor supervision."
    - question: "How can good cholesterol (HDL) be raised?"
      answer: "Regular aerobic exercise, quitting smoking, consuming healthy fats (olive oil, avocado, fish), and reaching ideal weight help raise HDL cholesterol."
    - question: "Is high triglyceride dangerous?"
      answer: "Yes, high triglyceride levels also contribute to atherosclerosis and can specifically increase the risk of pancreatitis."
...
1.  **Hypercholesterolemia:** High levels of cholesterol in the blood.
...
**Diagnosis Method:**
Diagnosis is made with a simple blood test **(Lipid Profile)** performed after 9-12 hours of fasting. Total Cholesterol, LDL, HDL, and Triglyceride levels are checked in this test.
...
{{< alert type="warning" >}}
Remember, cholesterol medications are not addictive, but continuity of treatment is essential. Discontinuing medication without consulting your doctor can increase the risk of heart attack again.
{{< /alert >}}
...
_This content has been prepared by Assoc. Prof. Dr. Habib ÇİL for general informational purposes. Please consult a cardiology specialist for definitive diagnosis and treatment._

## Related Topics

Other cardiology conditions and treatments related to hyperlipidemia:

- [Coronary Artery Disease](false/) - Vascular blockage
