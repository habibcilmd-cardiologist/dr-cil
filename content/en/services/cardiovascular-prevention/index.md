...
faq:
    - question: "What is cardiovascular prevention?"
      answer: "It encompasses all medical and lifestyle interventions aimed at preventing the onset of cardiovascular diseases (primary prevention) or halting progression and preventing new events in established disease (secondary prevention)."
    - question: "How is cardiovascular risk calculated?"
      answer: "Physicians use scoring systems like SCORE2, Framingham, or ASCVD. Data such as age, gender, smoking status, cholesterol levels, and blood pressure are used in this calculation."
    - question: "Who should undergo cardiovascular risk assessment?"
      answer: "It is recommended for all individuals over 40, and younger individuals with a family history of premature heart disease, diabetes, hypertension, or obesity."
    - question: "Which medications are used in preventive therapy?"
      answer: "Depending on the risk level, blood thinners (aspirin, etc.), lipid-lowering drugs (statins), and antihypertensives (ACE inhibitors, etc.) may be used under physician supervision."
    - question: "Are diet and exercise alone enough to prevent heart disease?"
      answer: "Lifestyle changes are very effective in low and moderate-risk individuals. However, in the presence of high genetic risk or advanced atherosclerosis, medical treatment is often necessary."
    - question: "How does stress affect heart health?"
      answer: "Chronic stress can raise blood pressure and trigger inflammation by increasing adrenaline and cortisol hormones. Stress management is a crucial part of cardiovascular prevention."
    - question: "How much does quitting smoking reduce risk?"
      answer: "Risk of heart disease drops by 50% within 1 year of quitting smoking. In the long term, it can approach the level of a non-smoker."
...
1.  **Primary Prevention:** Aimed at preventing the disease from ever occurring in individuals who have not yet been clinically diagnosed with heart or vascular disease but carry risk factors. (e.g., treating a smoker with high blood pressure who does not yet have arterial blockage).
2.  **Secondary Prevention:** Aimed at stopping disease progression and preventing the development of a new event (recurrence) in patients who have previously had a heart attack, stroke, stent placement, or bypass surgery.
...
{{< alert type="warning" >}}
**Warning:** "Herbal cures" or unproven methods found on the internet cannot replace your current medical treatment and may interact with your medications, leading to serious side effects. Consult your cardiologist before using any supplements.
{{< /alert >}}
...
_This page content has been prepared for informational purposes, referencing current European Society of Cardiology (ESC) and American Heart Association (AHA) guidelines._
