...
1. **Anesthesia**: Local anesthesia + sedation (or general anesthesia)
2. **Vascular access**: Femoral vein (groin)
3. **Catheter placement**: To heart under fluoroscopy guidance
4. **Mapping**: Determination of arrhythmia source
5. **Ablation**: Energy application to target area
6. **Testing**: Verification that arrhythmia cannot be induced
