...
EVAR is stent-graft placement into the aortic aneurysm through the groin. The aneurysm is supported from outside, eliminating rupture risk.
...
| ------------- | -------------- | --------------- |
| Incision      | Small (groin)  | Large (abdomen) |
...
2. **Femoral artery access**: Both groins
3. **Guidewire advancement**: To aorta
4. **Main body placement**: Over aneurysm
