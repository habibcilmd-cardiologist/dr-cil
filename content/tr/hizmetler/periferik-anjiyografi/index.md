---
title: "Periferik Anjiyografi - Uzuv Damar Görüntüleme"
description: "İstanbul'da periferik anjiyografi. Bacak, kol ve karın damarlarının görüntülenmesi. Doç. Dr. Habib Çil ile tanısal damar değerlendirmesi. Avrasya Hospital."
date: 2024-01-15
lastmod: 2024-12-13
draft: false
...
faq:
    - question: "Periferik anjiyografi nedir?"
      answer: "Periferik anjiyografi, kalp dışındaki damarların (bacak, kol, karın, boyun) kontrast madde ve röntgen ile görüntülenmesidir."
    - question: "Periferik anjiyografi ne zaman yapılır?"
      answer: "Bacak ağrısı, yürüme zorluğu, ayak yarası, böbrek damar hastalığı şüphesi veya felç riski değerlendirmesi için yapılır."
    - question: "Periferik anjiyografi ağrılı mı?"
      answer: "Lokal anestezi altında yapıldığı için ağrı hissedilmez. Kontrast madde verildiğinde geçici sıcaklık hissi olabilir."
    - question: "Periferik anjiyografi ne kadar sürer?"
      answer: "Tanısal periferik anjiyografi genellikle 30-60 dakika sürer. Tedavi eklenirse süre uzayabilir."
    - question: "Periferik anjiyografi sonrası ne zaman eve gidebilirim?"
      answer: "Genellikle aynı gün veya ertesi gün taburculuk mümkündür."
---
...
| Bölge | Arterler | Klinik Durum |
|-------|----------|--------------|
| **Alt Ekstremite** | İliak, femoral, popliteal, tibial | Bacak ağrısı, yara |
| **Üst Ekstremite** | Subklaviyan, aksiller, brakiyal | Kol ağrısı, soğukluk |
| **Karın** | Aort, mezenterik, renal | Böbrek, bağırsak |
| **Boyun** | Karotis, vertebral | İnme riski |
...
| Derece | Darlık (%) | Klinik Önemi |
|--------|-----------|--------------|
| Hafif | <50% | Takip |
| Orta | 50-70% | Semptoma göre |
| Ciddi | 70-99% | Tedavi gerekli |
| Tıkanık | %100 | Acil değerlendirme |
...
|--------------|--------|---------|
| Hematom | %2-5 | Bası, izlem |
| Psödoanevrizma | %0.5-1 | US eşliğinde kompresyon |
| AV fistül | <%0.5 | Cerrahi/girişimsel |
| Retroperitoneal kanama | <%0.5 | Transfüzyon, cerrahi |
...
| Özellik | Anjiyografi | BT Anjiyografi | Doppler US |
|---------|-------------|----------------|------------|
| İnvazivlik | Evet | Hayır | Hayır |
| Tedavi imkanı | Evet | Hayır | Hayır |
| Radyasyon | Var | Var | Yok |
| Kontrast | Evet | Evet | Hayır |
| Detay | En iyi | İyi | Orta |
