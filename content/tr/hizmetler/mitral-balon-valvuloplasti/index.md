---
title: "Mitral Balon Valvüloplasti (PMBV) - Mitral Kapak Genişletme"
description: "İstanbul'da mitral balon valvüloplasti (PMBV). Mitral darlığı tedavisinde ameliyatsız kapak genişletme. Doç. Dr. Habib Çil ile girişimsel tedavi. Avrasya Hospital."
date: 2024-01-15
lastmod: 2024-12-13
draft: false
...
faq:
    - question: "Mitral balon valvüloplasti nedir?"
      answer: "Mitral balon valvüloplasti, daralmış mitral kapağın balon kateter ile genişletilmesi işlemidir. Açık kalp ameliyatına gerek kalmadan yapılan minimal invaziv bir tedavidir."
    - question: "Mitral balon valvüloplasti kimlere uygulanır?"
      answer: "Semptomatik mitral darlığı olan, kapak anatomisi uygun ve ciddi mitral yetersizliği olmayan hastalara uygulanır. Özellikle romatizmal mitral darlığında tercih edilir."
    - question: "Mitral balon valvüloplasti sonrası iyileşme süresi ne kadar?"
      answer: "Genellikle 1-2 gün hastanede kalış yeterlidir. 1 hafta içinde normal aktivitelere dönülebilir."
    - question: "Mitral balon valvüloplasti kalıcı mı?"
      answer: "Evet, uygun hastalarda uzun süreli etki sağlar. 10-20 yıl restenoz olmadan geçirebilir, ancak bazı hastalarda yıllar sonra tekrar işlem gerekebilir."
    - question: "Mitral balon valvüloplasti riskleri nelerdir?"
      answer: "Ciddi mitral yetersizliği (%1-2), kardiyak tamponad (<1%) ve embolizm nadir görülen komplikasyonlardır. Deneyimli merkezlerde güvenli bir işlemdir."
---
...
| Neden | Açıklama | Sıklık |
|-------|----------|--------|
| **Romatizmal** | Geçirilmiş romatizmal ateş | En sık (%90) |
| **Dejeneratif** | Yaşlanma ile kalsifikasyon | Nadir |
| **Konjenital** | Doğuştan kapak anomalisi | Çok nadir |
| **SLE/RA** | Otoimmün hastalıklar | Nadir |
...
| Parametre | 1 | 2 | 3 | 4 |
|-----------|---|---|---|---|
| **Mobilite** | İyi | Orta | Kısıtlı | Çok kısıtlı |
| **Kalınlaşma** | Minimal | Uç kalınlaşma | Yaygın | Ciddi |
| **Kalsifikasyon** | Yok | Hafif | Orta | Yaygın |
| **Subvalvüler** | Normal | Hafif | Orta | Ciddi |
...
|--------------|--------|---------|
| Ciddi mitral yetersizlik | %1-2 | Acil cerrahi |
| Kardiyak tamponad | <1% | Perikardiyosentez |
| Sistemik embolizm | <1% | Antikoagülasyon |
| Atriyal septal defekt | %5-10 | Çoğu spontan kapanır |
| Vasküler komplikasyon | %2-3 | Lokal onarım |
...
| Özellik | PMBV | Cerrahi |
|---------|------|---------|
| İnvazivlik | Minimal | Açık kalp |
| Hastanede kalış | 1-2 gün | 7-10 gün |
| İyileşme | 1 hafta | 6-8 hafta |
| Anestezi | Sedasyon/Genel | Genel |
| Tekrarlanabilirlik | Evet | Zor |
| Uzun dönem | İyi | Mükemmel |
