...
1. **Anestezi**: Lokal anestezi + sedasyon (veya genel anestezi)
2. **Damar erişimi**: Femoral ven (kasık)
3. **Kateter yerleştirme**: Floroskopi eşliğinde kalbe
4. **Haritalama**: Aritminin kaynağının belirlenmesi
5. **Ablasyon**: Hedef bölgeye enerji uygulaması
6. **Test**: Aritminin indüklenememesinin doğrulanması
