...
{{< alert "danger" >}}
**Acil Uyarı:** Ani başlayan şiddetli nefes darlığı, göğüs ağrısı, bayılma veya pembe köpüklü balgam çıkarma durumlarında hemen 112'yi arayın! Bu belirtiler akut kalp yetmezliğini işaret edebilir.
{{< /alert >}}
...
{{< alert "warning" >}}
**Önemli:** Komplikasyon riski deneyimli merkezlerde ve uygun hasta seçiminde minimal düzeydedir. İşlem öncesi detaylı değerlendirme ve multidisipliner yaklaşım riskleri azaltır.
{{< /alert >}}
...
-   1. ay: Klinik değerlendirme ve ekokardiyografi
-   3. ay: Kontrol muayene
-   6. ay: Detaylı değerlendirme
