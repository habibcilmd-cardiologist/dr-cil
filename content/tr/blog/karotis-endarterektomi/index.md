---
title: 'Karotis Endarterektomi: Boyun Şah Damarı Ameliyatı Hakkında Bilmeniz Gerekenler'
...
faq:
- question: Karotis endarterektomi nedir?
  answer: Karotis endarterektomi (CEA), boyundaki karotis (şah) atardamarının iç yüzeyinde
    biriken aterosklerotik plakların cerrahi olarak temizlenmesi işlemidir. Bu ameliyat
    sayesinde beyne giden kan akımı artırılır ve inme (felç) riski önemli ölçüde azaltılır.
- question: Karotis endarterektomi kimlere uygulanır?
  answer: Karotis endarterektomi genellikle şu hastalara önerilir; karotis damarında
    yüzde 70 ve üzerinde darlık saptanan semptomatik hastalar, geçici iskemik atak
    (TIA) veya hafif inme geçirmiş hastalar, yüzde 60 üzerinde darlığı olan ancak
    semptom göstermeyen bazı yüksek riskli hastalar. Hastanın genel sağlık durumu,
    yaşı ve risk faktörleri tedavi kararında belirleyicidir.
- question: Karotis endarterektomi nasıl yapılır?
  answer: Ameliyat genel veya lokal anestezi altında gerçekleştirilir. Boynun yan
    tarafında kesi yapılarak karotis damarına ulaşılır. Damar geçici olarak klemplerle
    kapatılır ve açılarak içindeki aterosklerotik plak çıkarılır. Damar genellikle
    yama (patch) ile genişletilerek kapatılır ve kan akımı yeniden sağlanır. İşlem
    ortalama bir ila iki saat sürer.
- question: Karotis endarterektomi ve karotis stentleme arasındaki fark nedir?
  answer: Karotis endarterektomi açık cerrahi bir yöntemdir ve plakların fiziksel
    olarak çıkarılmasını içerir. Karotis stentleme (CAS) ise kasıktan kateter ile
    girilerek darlık bölgesine stent yerleştirilen minimal invaziv bir yöntemdir.
    Endarterektomi uzun dönem sonuçları açısından genellikle daha başarılıdır, özellikle
    yaşlı hastalarda ve kalsifik plaklarda. Stentleme ise cerrahi riski yüksek hastalarda
    tercih edilebilir.
- question: Karotis endarterektominin riskleri nelerdir?
  answer: Her cerrahi işlem gibi karotis endarterektominin de bazı riskleri vardır.
    Bunlar arasında ameliyat sırasında veya sonrasında inme gelişmesi, kalp krizi,
    kraniyal sinir yaralanması (ses kısıklığı, yutma güçlüğü), boyun bölgesinde kanama
    veya hematom, yara yeri enfeksiyonu ve damarın yeniden daralması (restenoz) sayılabilir.
    Deneyimli merkezlerde bu komplikasyon oranları oldukça düşüktür.
- question: Karotis endarterektomi sonrası iyileşme süreci nasıldır?
  answer: Hastalar genellikle bir ila üç gün hastanede kalır. Yara bakımı basittir
    ve dikişler yaklaşık bir hafta sonra alınır. Çoğu hasta bir iki hafta içinde normal
    günlük aktivitelerine dönebilir. İlaç tedavisine (antiplatelet, statin) devam
    edilmesi, risk faktörlerinin kontrolü ve düzenli takip önemlidir. Ağır fiziksel
    aktivitelerden birkaç hafta kaçınılması önerilir.
- question: Karotis endarterektomi felç riskini ne kadar azaltır?
  answer: Klinik çalışmalar semptomatik karotis darlığı olan hastalarda karotis endarterektominin
    felç riskini yaklaşık yüzde 50-60 oranında azalttığını göstermiştir. Asemptomatik
    hastalarda da beş yıllık felç riski medikal tedaviye kıyasla belirgin şekilde
    daha düşüktür. Ameliyatın başarısı hastanın durumuna, darlık derecesine ve cerrahın
    deneyimine bağlıdır.
- question: Karotis endarterektomi yerine ilaç tedavisi yeterli olabilir mi?
  answer: Bazı durumlarda, özellikle daha düşük dereceli darlıklarda veya cerrahi
    riski çok yüksek hastalarda, agresif medikal tedavi (antiplatelet ilaçlar, statinler,
    kan basıncı kontrolü, sigara bırakma) öncelikli tercih olabilir. Ancak ciddi darlıklarda
    ve semptomatik hastalarda cerrahi veya stentleme genellikle medikal tedaviye üstündür.
    Tedavi kararı hastanın bireysel durumuna göre verilmelidir.
---
