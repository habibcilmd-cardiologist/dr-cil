...
- question: "Anevrizma belirtileri nelerdir?"
  answer: "Çoğu anevrizma belirti vermez. Karın ağrısı, sırt ağrısı veya karında nabız hissi olabilir."
- question: "EVAR nedir?"
  answer: "EVAR (Endovasküler Anevrizma Onarımı), kasıktan girilerek stent-greft yerleştirilen minimal invaziv (ameliyatsız) anevrizma onarımıdır."
...
{{< lead >}}
Abdominal Aort Anevrizması (AAA), karın bölgesindeki vücudun ana atardamarı olan aortun anormal genişlemesidir. Genellikle sinsi ilerleyen ve "sessiz katil" olarak bilinen bu hastalık, yırtılması (rüptür) durumunda hayati risk oluşturur. Girişimsel Kardiyoloji Uzmanı Doç. Dr. Habib Çil, AAA'nın erken tanısı, takibi ve ameliyatsız tedavi yöntemi olan EVAR hakkında bilinmesi gerekenleri anlatıyor.
{{< /lead >}}
...
{{< alert "danger" >}}
Şiddetli karın ağrısı ve baygınlık hissi varsa vakit kaybetmeden **112 Acil Servis** aranmalı veya en yakın hastaneye başvurulmalıdır.
{{< /alert >}}
