...
{{< alert "danger" >}}
**Acil Uyarı:** Ani bayılma, şiddetli göğüs ağrısı veya ciddi nefes darlığı durumlarında hemen 112'yi arayın! Bu belirtiler hayatı tehdit edici olabilir.
{{< /alert >}}
...
{{< alert "warning" >}}
**Önemli:** Hipertrofik kardiyomiyopatili hastalar yarışmacı sporlardan kaçınmalıdır. Egzersiz programı mutlaka kardiyolog kontrolünde planlanmalıdır.
{{< /alert >}}
