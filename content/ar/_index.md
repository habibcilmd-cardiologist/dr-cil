---
title: "أ.م.د. حبيب جيل | أخصائي أمراض القلب"
description: "أ.م.د. حبيب جيل - أخصائي أمراض القلب في إسطنبول. خبير في رأب الأوعية التاجية، TAVI، زراعة جهاز تنظيم ضربات القلب، تخطيط صدى القلب وأمراض القلب التداخلية مع خبرة تزيد عن 20 عاماً."
layout: "profile"
translationKey: "home"
...
<div class="hero-section">
  <div class="hero-badges">
    <span class="badge">خبرة أكثر من 20 عاماً</span>
  ...
  <div class="hero-description">
    <p>خريج كلية الطب بجامعة إسطنبول جراح باشا، متخصص في أمراض القلب من جامعة أكدينيز. مع أكثر من 20 عاماً من الخبرة السريرية والمسيرة الأكاديمية، أقدم لمرضاي أحدث طرق التشخيص والعلاج.</p>
  </div>
...
<div class="services-grid">
  ...
  <a href="/ar/services/#pacemaker-and-electrophysiology" class="service-card">
    <div class="service-icon">⚡</div>
    <h4>جهاز تنظيم ضربات القلب والفيزيولوجيا الكهربية</h4>
    <p>جهاز تنظيم ضربات القلب، ICD، علاجات الاستئصال</p>
  </a>
  <a href="/ar/services/#diagnostic-procedures" class="service-card">
    <div class="service-icon">🩺</div>
