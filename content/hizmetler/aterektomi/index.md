...
faq:
    - question: "Aterektomi nedir ve ne zaman gerekir?"
      answer: "Aterektomi, damar içindeki aterosklerotik plakların mekanik olarak temizlenmesi
        işlemidir. Ciddi kalsifiye lezyonlarda, balon ile geçilemeyen darlıklarda,
        stent ekspansiyonunun yetersiz olduğu durumlarda veya in-stent restenozda tercih edilir.
        Hem koroner hem de periferik arterlerde uygulanabilir."
    - question: "Aterektomi türleri nelerdir?"
      answer: "Dört ana aterektomi türü vardır: Rotasyonel aterektomi (Rotablator) elmas
        kaplı burr ile kalsifiye plağı öğütür. Orbital aterektomi eksantrik rotasyon
        ile plağı aşındırır. Direktional aterektomi plağı keser ve toplar. Lazer aterektomi
        excimer lazer ile plağı buharlaştırır. Hangi yöntemin kullanılacağı lezyon
        özelliklerine göre belirlenir."
    - question: "Aterektomi ağrılı mı?"
      answer: "Hayır, aterektomi lokal veya genel anestezi altında yapılır ve işlem
        sırasında ağrı hissedilmez. İşlem sonrası erişim bölgesinde hafif rahatsızlık
        olabilir ancak bu genellikle kısa sürelidir ve basit ağrı kesicilerle kontrol edilir."
    - question: "Aterektomi sonrası stent gerekir mi?"
      answer: "Çoğu durumda aterektomi sonrası stent yerleştirilir. Aterektomi tek
        başına bir tedavi olmaktan çok, stent yerleştirilmesi için damar yatağını
        hazırlayan bir işlemdir. Kalsifiye plağın temizlenmesi sayesinde stent daha
        iyi açılır ve damar duvarına daha iyi oturur."
    - question: "Aterektominin riskleri nelerdir?"
      answer: "Aterektomi genel olarak güvenli bir işlemdir ancak bazı riskler mevcuttur.
        Distal embolizasyon (plak parçalarının ileriye taşınması), damar perforasyonu,
        yavaş akım fenomeni ve spazm görülebilir. Bu komplikasyonlar deneyimli merkezlerde
        nadir görülür ve genellikle işlem sırasında yönetilebilir."
    - question: "Aterektomi sonrası iyileşme süreci nasıldır?"
      answer: "Aterektomi sonrası hastalar genellikle 1-2 gün hastanede kalır. Erişim
        bölgesinin iyileşmesi birkaç gün sürer. Çoğu hasta bir hafta içinde normal
        aktivitelerine dönebilir. Antiplatelet tedaviye devam edilmesi ve düzenli
        kontrollere gidilmesi önemlidir."
    - question: "Koroner ve periferik aterektomi arasındaki fark nedir?"
      answer: "Koroner aterektomi kalbi besleyen arterlerdeki kalsifiye plakların
        temizlenmesidir. Periferik aterektomi ise bacak, böbrek veya diğer periferik
        arterlerdeki plakların temizlenmesidir. Temel prensip aynı olsa da kullanılan
        cihaz boyutları ve teknik detaylar farklılık gösterebilir."
    - question: "Hangi hastalar aterektomi için uygun adaydır?"
      answer: "Aterektomi özellikle ciddi kalsifiye koroner veya periferik lezyonları
        olan, standart balon anjiyoplasti ile tedavi edilemeyen, stent ekspansiyonu
        yetersiz kalan veya in-stent restenozu olan hastalar için uygundur. Hasta
        seçimi detaylı anjiyografik değerlendirme ve intravasküler görüntüleme ile yapılır."
---
