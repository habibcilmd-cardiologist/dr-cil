---
title: "Kardiyovasküler Korunma - Primer ve Sekonder Önleme"
description: "Kalp ve damar hastalıklarından korunma yolları. Kardiyovasküler risk hesaplama, yaşam tarzı değişiklikleri, tansiyon ve kolesterol yönetimi konusunda kapsamlı tıbbi bilgilendirme."
date: 2024-01-20
lastmod: 2025-12-09
draft: false
...
faq:
    - question: "Kardiyovasküler (Kalp-Damar) koruma nedir?"
      answer: "Kalp ve damar hastalıklarının ortaya çıkmasını engellemek (primer koruma) veya hastalığı olan kişilerde ilerlemeyi durdurup yeni olayları önlemek (sekonder koruma) amacıyla yapılan tıbbi ve yaşam tarzı düzenlemelerinin tümüdür."
    - question: "Kardiyovasküler risk nasıl hesaplanır?"
      answer: "Hekimler tarafından SCORE2, Framingham veya ASCVD gibi risk skorlama sistemleri kullanılır. Bu hesaplamada yaş, cinsiyet, sigara kullanımı, kolesterol düzeyleri ve kan basıncı gibi veriler dikkate alınır."
    - question: "Kimler kardiyovasküler risk değerlendirmesi yaptırmalıdır?"
      answer: "40 yaş üzerindeki tüm bireylerin, ayrıca ailesinde erken yaşta kalp hastalığı öyküsü olan, diyabeti, hipertansiyonu veya obezitesi bulunan daha genç bireylerin risk değerlendirmesi yaptırması önerilir."
    - question: "Koruyucu tedavide hangi ilaçlar kullanılır?"
      answer: "Risk düzeyine göre kan sulandırıcılar (aspirin vb.), kolesterol düşürücüler (statinler), tansiyon ilaçları (ACE inhibitörleri vb.) hekim kontrolünde kullanılabilir. İlaç kararı kişiye özel verilir."
    - question: "Sadece diyet ve spor kalp hastalığını önler mi?"
      answer: "Düşük ve orta riskli bireylerde yaşam tarzı değişiklikleri çok etkilidir. Ancak yüksek genetik risk veya ileri evre ateroskleroz (damar sertliği) varlığında medikal tedavi genellikle gereklidir."
    - question: "Stres kalp sağlığını nasıl etkiler?"
      answer: "Kronik stres, adrenalin ve kortizol hormonlarını artırarak tansiyonu yükseltebilir ve inflamasyonu tetikleyebilir. Stres yönetimi, kardiyovasküler korunmanın önemli bir parçasıdır."
    - question: "Sigarayı bırakmak riski ne kadar azaltır?"
      answer: "Sigarayı bıraktıktan sonraki 1 yıl içinde kalp hastalığı riski %50 oranında azalır. Uzun vadede ise hiç içmemiş seviyelerine yaklaşabilir."
    - question: "Alkol kullanımı kalp sağlığı için riskli midir?"
      answer: "Aşırı alkol tüketimi hipertansiyon, ritim bozuklukları (atriyal fibrilasyon) ve kalp kası hastalıklarına (kardiyomiyopati) yol açabilir. Sınırlı tüketim veya hiç tüketmemek önerilir."
---
...
_Bu sayfa içeriği, güncel Avrupa Kardiyoloji Derneği (ESC) ve Amerikan Kalp Cemiyeti (AHA) kılavuzları referans alınarak bilgilendirme amacıyla hazırlanmıştır._
